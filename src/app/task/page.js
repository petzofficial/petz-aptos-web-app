                ...
                <div className="addcontainer 2xl:px-5 lg:px-14 md:px-10 sm:px-6 max-sm:px-3">
                    <div className="tasks-inner lg:mb-16 max-lg:mb-8">
                        ...
                        <div className="tasks-right flex-1 lg:w-[466px] m-auto lg:mt-[-356px]">
                            ...
                            {items.map((item) => {
                                return <Link key={item.id} href={'/task/task-details'}>
                                    <div className="box flex items-center lg:w-[466px] px-2 py-1 justify-between">
                                        <div style={{ backgroundColor: item.color }} className={`color`}></div>
                            ...
                            <div className="add-task-btn">
                                <Link href={'/task/task-add'}><button>Add New Task</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
