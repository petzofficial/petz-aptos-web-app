      ...
      <div className="addcontainer">
        <div className="without-inner">
          <div className="title-image m-auto">
            <Image src={header} width={326} height={218} alt="PetZ" className="m-auto" />
          </div>
          <h3>OOPS</h3>
          <p className="font-semibold">No data found...</p>

          <div className="selection-button">
            <Link href={'https://nftrade.com'}><button>Buy PetZ NFT</button></Link>
            <Link href={'/home'}><button>Continue without NFT</button></Link>
          </div>
