          ...
          <div className="home-inner">
            ...
            <div className="first-box mt-5">
              ...
              <div className="box-inner flex items-center">
                ...
                <h4 className={`ml-3 -mt-2 font-bold ${jakarta.className}`}>80%</h4>
              </div>
            </div>
            ...
            <div className="first-box mt-5">
              ...
              <select name="task" id="task" className='w-full outline-none'>
                <option className='font-semibold' value="choose">Choose Task</option>
            ...
            <div className="first-box mt-5">
              ...
              <div class="containerr">
                ...
                <div className={`absolute max-sm:text-[33px] sm:text-[40px] md:text-[43px] lg:text-[48px] font-semibold ${barlow.className}`}>
                  25:00
                </div>
              </div>
              ...
              <div className="play-move-btn space-x-2 mt-5">
                <button><FaSquare /></button>
                <button className='mid'><FaPlay /></button>
                <button><ReplayIcon className='font-bold' /></button>
              </div>
            </div>
