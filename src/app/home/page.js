  ...
  return (
    <section className="connect-wallet lg:h-[100vh] 2xl:px-5 lg:px-14 md:px-10 sm:px-6 max-sm:px-3">
      <div className="addcontainer">
        <div
          className={`connect-wallet-inner md:flex justify-between items-center ${urban.className}`}
        >
          <div className="connect-wallet-left">
            ...
            <div className="text-box md:p-6 max-md:p-3">
              ...
              <p className="font-medium">
                Start by connecting with one of the following wallet providers
                or create a new wallet entirely
              </p>
              <p className="font-semibold">
                By connecting to our platfom, I agree to the
