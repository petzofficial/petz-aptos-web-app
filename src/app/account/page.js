                    ...
                    <div className="account-top">
                        <div className='xl:w-[250px] lg:w-[200px] max-md:m-auto'>
                            ...
                            <div className="token-trans-btn">
                                <button className={`${slug === 'token' ? 'bg-[#FEE4D1] text-[#FF6900]' : ''}`} onClick={() => setSlug('token')}><TbCircleLetterT /> <span>Token</span></button>
                                <button className={`${slug === 'transactions' ? 'bg-[#FEE4D1] text-[#FF6900]' : ''}`} onClick={() => setSlug('transactions')}><FaArrowRightArrowLeft /> <span>Transactions</span></button>
                            </div>
                        </div>
                        <div className='max-width m-auto lg:mt-[-214px]'>
                            <h2 className={`flex justify-center ${outfit.className}`}>Account</h2>
                            ...
                            <div className="first-box flex justify-between items-center mt-5 max-sm:!px-[5px]">
                                <p className='max-sm:text-[12px]'>0x9f18a7c9285168ccAF0F162c9aC5D704</p>
                                <button className='text-[#FF6900]'><IoCopy /></button>
                            </div>
                            <div className="first-box mt-5">
                                <div className="box-inner flex items-center mt-3">
                                    ...
                                    <h4 className={`ml-3 -mt-2 font-bold ${jakarta.className}`}>60%</h4>
                                </div>
