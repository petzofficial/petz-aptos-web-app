...
import { getUserData, saveUserData } from "@/utilities/localDB";
...
const Page = () => {
  ...
  useEffect(() => {
    ...
    // Check if the existingUserData is empty
    if (Object.keys(existingUserData).length === 0) {
      // If user data doesn't exist or is empty, save default user data
