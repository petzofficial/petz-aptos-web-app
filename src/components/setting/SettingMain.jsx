      ...
      <form onSubmit={handleSave} className='flex flex-col space-y-5'>
        <div className='flex'>
          ...
          <label className='switch'>
            <input
              ...
              name='check'
              defaultChecked={
                settingsLocalData ? settingsLocalData.check : false
              }
            />
        ...
        <div className='flex'>
          ...
          <input
            ...
            name='focusTime'
            defaultValue={
              settingsLocalData ? settingsLocalData.focusTime : '25'
            }
        ...
        <div className='flex'>
          ...
          <input
            ...
            name='shortBreak'
            defaultValue={
              settingsLocalData ? settingsLocalData.shortBreak : '5'
            }
            className='w-9 h-5 text-right'
          />
        </div>
        <div className='flex'>
          ...
          <input
            ...
            name='longBreak'
            defaultValue={
              settingsLocalData ? settingsLocalData.longBreak : '15'
            }
            className='w-9 h-5 text-right'
          />
        </div>
        <div className='flex'>
          ...
          <input
            ...
            defaultValue={
              settingsLocalData ? settingsLocalData.currentCycleCount : '4'
            }
            className='w-9 h-5 text-right'
          />
        </div>
